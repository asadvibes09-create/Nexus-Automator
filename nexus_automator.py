...
class NexusAutomator:
    ...
    def create_ui(self):
        outer_frame = ctk.CTkFrame(self.root, fg_color=("#F0F2F5", "#0B0F19"))
        ...
        sidebar = ctk.CTkFrame(
            outer_frame,
            fg_color=("#E3E6E8", "#070A10"),
            width=220,
            corner_radius=0,
            border_width=1,
            border_color=("#DBE0E5", "#242C3D")
        )
        ...
        theme_label = ctk.CTkLabel(
            ...
            text_color=("#5C6370", "#94A3B8"),
            anchor="w"
        )
        theme_label.grid(row=6, column=0, padx=18, pady=(18, 4), sticky="w")

        self.theme_option = ctk.CTkOptionMenu(
            sidebar,
            values=["Dark", "Light"],
            fg_color=("#F8F9FA", "#1E2638"),
            button_color=("#DBE0E5", "#242C3D"),
            dropdown_hover_color=("#E3E6E8", "#1E2638"),
        ...
        self.theme_option.grid(row=7, column=0, padx=18, pady=(0, 18), sticky="ew")

        sidebar.grid_rowconfigure(8, weight=1)

        content_frame = ctk.CTkFrame(outer_frame, fg_color=("#FFFFFF", "#161B26"), corner_radius=16)
        ...
        header_subtitle = ctk.CTkLabel(
            ...
            font=("Segoe UI", 12),
            text_color=("#5C6370", "#9F9F9F"),
            anchor="w"
        )
        header_subtitle.grid(row=1, column=0, padx=24, pady=(0, 22), sticky="w")

        self.content_area = ctk.CTkFrame(content_frame, fg_color=("#FFFFFF", "#161B26"), corner_radius=16, border_width=1, border_color=("#DBE0E5", "#242C3D"))
        ...
        footer_bar = ctk.CTkFrame(content_frame, fg_color=("#F0F2F5", "#1D1D1D"), corner_radius=20)
    ...
    def select_tab(self, tab_name: str):
        ...
        inactive_style = {"fg_color": ("#E3E6E8", "#0B1220"), "text_color": ("#1A1A1A", "#94A3B8"), "hover_color": ("#DBE0E5", "#1E2638")}
    ...
    def create_organizer_tab(self):
        self.organizer_frame = ctk.CTkFrame(self.content_area, fg_color=("#F5F6F7", "#1B1B1B"), corner_radius=16)
        ...
        subtitle = ctk.CTkLabel(
            ...
            font=("Segoe UI", 11),
            text_color=("#5C6370", "#A9A9A9"),
            anchor="w"
        )
        subtitle.grid(row=1, column=0, sticky="w", padx=24)

        folder_card = ctk.CTkFrame(self.organizer_frame, fg_color=("#F8F9FA", "#1E2638"), corner_radius=12, border_width=1, border_color=("#DBE0E5", "#242C3D"))
        folder_card.grid(row=2, column=0, columnspan=2, sticky="ew", padx=18, pady=(18, 14))
        ...
        self.folder_path_label.grid(row=0, column=0, sticky="w", padx=18, pady=18)
        ...
        details_card = ctk.CTkFrame(self.organizer_frame, fg_color=("#F8F9FA", "#1E2638"), corner_radius=12, border_width=1, border_color=("#DBE0E5", "#242C3D"))
        details_card.grid(row=3, column=0, columnspan=2, sticky="ew", padx=18, pady=(0, 10))
        ...
        details_title.grid(row=0, column=0, sticky="w", padx=18, pady=(10, 2))
        ...
        self.info_label = ctk.CTkLabel(
            ...
            font=("Segoe UI", 10),
            text_color=("#5C6370", "#C4C4C4"),
            justify="left",
            wraplength=760
        )
        self.info_label.grid(row=1, column=0, sticky="ew", padx=18, pady=(0, 5))

        self.ai_toggle_var = BooleanVar(value=False)
        self.ai_toggle = ctk.CTkSwitch(
            details_card,
            text="Enable Smart AI Categorization",
            text_color=("#1A1A1A", "#FFFFFF"),
            variable=self.ai_toggle_var,
            command=self._on_ai_toggle,
        )
        self.ai_toggle.grid(row=2, column=0, sticky="w", padx=18, pady=5)

        actions_card = ctk.CTkFrame(self.organizer_frame, fg_color=("#F8F9FA", "#1E2638"), corner_radius=12, border_width=1, border_color=("#DBE0E5", "#242C3D"))
        actions_card.grid(row=4, column=0, columnspan=2, sticky="ew", padx=18, pady=(0, 25))
        ...
        self.organize_btn.grid(row=0, column=0, sticky="ew", padx=(18, 8), pady=(10, 10))

        reset_btn = ctk.CTkButton(
            actions_card,
            text="🔄 Reset",
            fg_color=("#E8E8E8", "#2a2a2a"),
            hover_color=("#D1D1D1", "#333333"),
            text_color=("#1A1A1A", "#FFFFFF"),
            font=("Segoe UI", 12, "bold"),
            corner_radius=12,
        ...
        reset_btn.grid(row=0, column=1, sticky="ew", padx=(8, 18), pady=(10, 10))

        self.organizer_status = ctk.CTkLabel(
            self.organizer_frame,
            text="",
            font=("Segoe UI", 10),
            text_color=("#0078D4", "#00d4ff"),
            anchor="w"
        )
        self.organizer_status.grid(row=5, column=0, columnspan=2, sticky="w", padx=24, pady=(0, 16))

    def create_renamer_tab(self):
        self.renamer_frame = ctk.CTkFrame(self.content_area, fg_color=("#FFFFFF", "#161B26"), corner_radius=16)
        ...
        rename_card = ctk.CTkFrame(self.renamer_frame, fg_color=("#F8F9FA", "#1E2638"), corner_radius=12, border_width=1, border_color=("#DBE0E5", "#242C3D"))
        ...
        prefix_card = ctk.CTkFrame(self.renamer_frame, fg_color=("#F8F9FA", "#1E2638"), corner_radius=12, border_width=1, border_color=("#DBE0E5", "#242C3D"))
        ...
        self.renamer_status = ctk.CTkLabel(
            ...
            text="",
            font=("Segoe UI", 10),
            text_color=("#0078D4", "#00E5FF"),
            anchor="w"
        )
        self.renamer_status.grid(row=5, column=0, sticky="w", padx=24, pady=(0, 22))

    def create_scraper_tab(self):
        self.scraper_frame = ctk.CTkFrame(self.content_area, fg_color=("#FFFFFF", "#161B26"), corner_radius=16)
        ...
        scraper_card = ctk.CTkFrame(self.scraper_frame, fg_color=("#F8F9FA", "#1E2638"), corner_radius=12, border_width=1, border_color=("#DBE0E5", "#242C3D"))
        ...
        format_card = ctk.CTkFrame(self.scraper_frame, fg_color=("#F8F9FA", "#1E2638"), corner_radius=12, border_width=1, border_color=("#DBE0E5", "#242C3D"))
        ...
        self.extract_btn = ctk.CTkButton(
            self.scraper_frame,
            text="Extract Data",
            fg_color=("#00E5FF", "#00E5FF"),
            hover_color=("#4F46E5", "#4F46E5"),
            text_color=("#070A10", "#070A10"),
            font=("Segoe UI", 12, "bold"),
            corner_radius=12,
    ...
    def browse_folder(self):
        ...
        if folder:
            ...
            self.folder_path_label.configure(text=display_path, text_color=("#0078D4", "#00d4ff"))
    ...
    def browse_renamer_folder(self):
        ...
        if folder:
            ...
            display_path = folder if len(folder) < 40 else "..." + folder[-37:]
            self.rename_folder_label.configure(text=display_path, text_color=("#0078D4", "#00d4ff"))
            self.renamer_status.configure(text="✓ Folder selected. Ready to rename!")
            self.progress_label.configure(text="Ready to rename")

    def _on_ai_toggle(self):
        if getattr(self, 'ai_toggle_var', None) and self.ai_toggle_var.get():
            self.organizer_status.configure(text="AI Smart Categorization: ON")
        else:
            self.organizer_status.configure(text="AI Smart Categorization: OFF")
    ...
    def _extract_text_from_docx(self, file_path: str) -> str:
        try:
            ...
            paragraphs = [p.text for p in doc.paragraphs if p.text][:5]
            return "\n".join(paragraphs)
        except Exception:
            return ""
    ...
    def categorize_document(self, file_path: str) -> str:
        keywords_map = {
            "Education, Research & Notes": [
                "assignment", "lecture", "notes", "research", "thesis", "book", "guide",
                "course", "study", "exam", "syllabus", "project", "presentation",
                "university", "bbit", "quiz"
            ],
            "Tech, Code & Development": [
                "python", "programming", "coding", "developer", "software", "database",
                "html", "css", "script", "documentation", "api", "tech", "git",
                "repository", "sql", "java", "vscode"
            ],
            "Invoices, Receipts & Finance": [
                "invoice", "receipt", "bill", "payment", "tax", "finance", "revenue",
                "profit", "loss", "accounting", "audit", "statement", "salary",
                "expense", "ledger", "khata"
            ],
            "Resumes, HR & Professional Docs": [
                "resume", "cv", "hiring", "recruitment", "hr", "human resources",
                "profile", "interview", "certificate", "bio", "cover letter", "experience"
            ],
            "Legal, Contracts & Agreements": [
                "contract", "agreement", "legal", "law", "act", "policy", "terms",
                "conditions", "compliance", "nda", "deed", "regulation", "court",
        ...
        for category, keywords in keywords_map.items():
            scores[category] = sum(content.count(keyword) for keyword in keywords)

        best_category, best_score = max(scores.items(), key=lambda item: item[1])
        sorted_scores = sorted(scores.items(), key=lambda item: item[1], reverse=True)

        if best_score == 0:
            filename_scores = {category: sum(filename_lower.count(keyword) for keyword in keywords) for category, keywords in keywords_map.items()}
            best_filename_category, best_filename_score = max(filename_scores.items(), key=lambda item: item[1])
            return best_filename_category if best_filename_score > 0 else "General Documents"
    ...
    def _organize_thread(self):
        try:
            ...
            for filename in files:
                ...
                # Default category behavior based on extensions
                category = "Other"
                ...
                # If AI smart categorization is enabled and this is a document, inspect text
                document_extensions = {".pdf", ".docx", ".doc"}
                if getattr(self, 'ai_toggle_var', None) and self.ai_toggle_var.get() and file_ext in document_extensions:
                    try:
                        matched = self.categorize_document(file_path)
                    except Exception:
                        matched = None

                    if matched:
                        category_folder = os.path.join(self.selected_folder, "Documents", matched)
                    else:
                        category_folder = os.path.join(self.selected_folder, "Documents", "Other Documents")
                else:
